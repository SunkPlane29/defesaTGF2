...
\begin{frame}{Análise Bayesiana}
	...
	\begin{equation}
		\begin{aligned}
			P(\bm D | \bm c_s^2, \bm \epsilon_c, I) & = \prod_{k=1}^N P(D_k | \bm c_s^2, p_{c,k}, I),                                              \\
			P(\bm c_s^2, \bm \epsilon_c | I)        & = \left[ \prod_{i=1}^{n} P(c_{s,i}^2 | I)\right]\left[ \prod_{k=1}^N P(p_{c,k} | I) \right].
		\end{aligned}
	\end{equation}
\end{frame}
